...
public class DailyQuestionController {
    ...
    /**
     * Key includes today's date so each day gets its own cache entry.
     * TTL 48h means yesterday's entry expires automatically without manual eviction.
    ...
    public List<String> getDailyQuestions() {
        ...
        try {
            ...
            log.info("Daily questions generated: {} items", questions.size());
            return questions;
        } catch (Exception e) {
